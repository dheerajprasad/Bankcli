...
public class TransactionRepositoryImpl implements TransactionRepository {
    ...
    private static final String GET_LOAN_DETAILS_DEBIT_USERID = "SELECT ID , DEBIT_USERID , DEBIT_ACCOUNT_ID , CREDIT_USERID , CREDIT_ACCOUNT_ID , TRANSACTION_AMOUNT , TRANSACTION_TYPE , CREATED_DATE , UPDATED_DATE FROM  USER_TRANSACTIONS where DEBIT_USERID=:DEBIT_USERID AND TRANSACTION_TYPE ='PAYMENT_INITIATED_LOAN'";
    private static final String GET_LOAN_DETAILS_CREDIT_USERID = "SELECT ID , DEBIT_USERID , DEBIT_ACCOUNT_ID , CREDIT_USERID , CREDIT_ACCOUNT_ID , TRANSACTION_AMOUNT , TRANSACTION_TYPE , CREATED_DATE , UPDATED_DATE FROM  USER_TRANSACTIONS where CREDIT_USERID=:CREDIT_USERID AND TRANSACTION_TYPE ='PAYMENT_INITIATED_LOAN'";
