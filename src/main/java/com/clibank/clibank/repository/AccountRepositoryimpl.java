...
public class AccountRepositoryimpl implements AccountRespository {
    ...
    private static final String CREATE_USER = "INSERT INTO USER_ACCOUNTDETAILS (USERID,ACCOUNT_NUMBER,BALANCE,EARMARKAMOUNT,VERSION,CREATED_DATE,UPDATED_DATE) VALUES (:USERID,:ACCOUNT_NUMBER,:BALANCE,:EARMARKAMOUNT,:VERSION,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)";
    private static final String GET_ACCOUNT = "SELECT ID,USERID,ACCOUNT_NUMBER,BALANCE,EARMARKAMOUNT,VERSION,CREATED_DATE,UPDATED_DATE from USER_ACCOUNTDETAILS where userid=:USERID";
