...
public enum PaymentTransactionTypes {
    ...
    LOAN_UPDATE_SUCCESS_TRAN_CREATE_SUCCESS_LOAN_EARMARK_REVERT_FAILURE("031"),
    LOAN_TRANSFER_TO_CREDITOR_SUCESS_TRAN_CREATE_SUCCESS_LOAN_EARMARK_REVERT_FAILURE("032"),
